...
<div id="container">
	...
	<input type="button" onclick="printDiv('monthly')" value="Print Report" class="button" />
			...
			foreach ($clerk_list as $key => $value) 
				{
					...
					echo '<hr>';
	// HOLIDAY SECTION ################################################################
					$this->table->set_caption('Holiday Analitics');
				
					$this->table->add_row($holidays[$key]['holi_dates_ocured']);	
